...
import { getInterfaceDetailByDeclaration } from '../type/typeObtain';
...
//     };
// };
export const getInterface = (declaration: InterfaceDeclaration): TypeDeclaration[] =>{
    const [interfaceDetail, dep] = getInterfaceDetailByDeclaration(declaration);
    return [{
